...
class TestProductSpecific:
    ...
    def test_product_add_type_checking(self):
    ...
    def test_product_add_same_class_success(self):
    ...
    def test_smartphone_add_same_class_success(self):
    ...
    def test_lawn_grass_add_same_class_success(self):
    ...
    def test_product_new_product_method(self):
    ...
    def test_product_price_validation(self, capsys):
        """Тест валидации цены"""
        product = Product("Test", "Desc", 100.0, 5)
