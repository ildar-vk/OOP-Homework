...
class TestExceptions:
    ...
    def test_zero_quantity_product_creation(self) -> None:
    ...
    def test_zero_quantity_via_value_error(self) -> None:
    ...
    def test_middle_price_zero_price_product(self) -> None:
    ...
    def test_category_with_mixed_products(self) -> None:
    ...
    def test_product_creation_with_negative_quantity(self) -> None:
